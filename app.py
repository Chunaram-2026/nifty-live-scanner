...
def calculate_indicators(data):
    ...
    # Yahoo index data may have zero volume.
    # In that case OHLC/4 is used as fallback.
...
def api_data():
    ...
    try:
        ...
        # Calculate once and use everywhere
